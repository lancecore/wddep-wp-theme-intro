		...
		<div class="row">
			<div class="col-md-4">
				<article class="blog-post">
					<figure>
						<a href="<?php echo get_stylesheet_directory_uri(); ?>/img/blog-img-01.jpg" class="single_image">
							<div class="blog-img-wrap">
								<div class="overlay">
									<i class="fa fa-search"></i>
								</div>
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/blog-img-01.jpg" alt="Sedna blog image"/>
							</div>
						</a>
						<figcaption>
			...
			<div class="col-md-4">
				<article class="blog-post">
					<figure>
						<a href="<?php echo get_stylesheet_directory_uri(); ?>/img/blog-img-02.jpg" class="single_image">
							<div class="blog-img-wrap">
								<div class="overlay">
									<i class="fa fa-search"></i>
								</div>
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/blog-img-02.jpg" alt="Sedna blog image"/>
							</div>
						</a>
						<figcaption>
					...
					<figure>
						<a href="img/blog-img-03.jpg" class="single_image">
							<div class="blog-img-wrap">
								...
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/blog-img-03.jpg" class="single_image" alt="Sedna blog image"/>
							</div>
						</a>
						<figcaption>
						<h2><a href="#" class="blog-category" data-toggle="tooltip" data-placement="top" data-original-title="See more posts">Product</a></h2>
